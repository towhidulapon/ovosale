...
@section('app-content')
    <main class="account">
        ...
        <div class="account__card">
            ...
            <form action="{{ route('user.login') }}" method="POST" class="account__form verify-gcaptcha">
                @csrf
                ...
                <x-captcha />
                <div class="form-group">
                    <button type="submit" id="recaptcha" class="btn btn--primary w-100  h-48 mb-2 fs-16">
