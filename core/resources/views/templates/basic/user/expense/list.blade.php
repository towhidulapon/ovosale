                                                            ...
                                                            <td>
                                                                <x-user.ui.btn.table_action module="expense" :id="$expense->id">
                                                                    ...
                                                                    @if (@$expense->attachment)
                                                                        <a href="{{ route('user.download.attachment', encrypt(getFilePath('expense_attachment') . '/' . @$expense->attachment)) }}" class="btn btn--success">
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="form-group col-lg-12">
                        ...
                        <input type="text" class="form-control date-picker" name="expense_date" required value="{{ old('expense_date') }}">
                    </div>
                    ...
                    <div class="form-group col-lg-6">
                        ...
                        <div class="input-group input--group">
                            ...
                            <input type="number" step="any" class="form-control" name="amount" required value="{{ old('amount') }}">
