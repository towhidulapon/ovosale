...
@section('panel')
    <div class="container ">
        <div class="row justify-content-center">
            <div class="col-lg-9">
                <form action="{{ route('user.subscription.plan.purchase.insert') }}" method="post" class="deposit-form no-submit-loader">
                    @csrf
                    ...
                    <div class="gateway-card">
                        <div class="row justify-content-center gy-sm-4 gy-3">
                            <div class="col-12">
                                <h5 class="payment-card-title">@lang('Purchase Plan')</h5>
                            </div>
                            <div class="col-lg-6">
                                    ...
                                    <div class="deposit-info">
                                        ...
                                        <div class="deposit-info__input">
                                            <div class="deposit-info__input-group input-group">
                                                ...
                                                <input type="text" class="form-control form--control amount" name="amount" placeholder="@lang('00.00')" value="{{ old('amount', isset($plan) ? getAmount($plan->price) : '') }}" autocomplete="off" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <hr>
