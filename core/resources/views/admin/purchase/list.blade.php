...
@section('panel')
    @include('admin.purchase.widget')
    <div class="row">
        <div class="col-12">
            <x-admin.ui.card>
                <x-admin.ui.card.body :paddingZero=true>
                    <x-admin.ui.table.layout filterBoxLocation="purchase.filter_box_purchase" :hasRecycleBin="false">
                        <x-admin.ui.table>
                                        ...
                                        <td class="dropdown">
                                            @if (request()->trash)
                                                <button type="button" class="btn btn-outline--success confirmationBtn"
                                                    ...
                                                    data-action="{{ route('admin.purchase.trash.restore', $purchase->id) }}">
                                            ...
                                            @else
                                                ...
                                                <div class="dropdown-menu dropdown">
                                                    ...
                                                    <x-permission_check permission="view purchase">
                                                        <a class="dropdown-list d-block w-100 text-start"
                                                            href="{{ route('admin.purchase.view', $purchase->id) }}">
                                                            <span class="me-2">
                                                    ...
                                                    <x-permission_check permission="print purchase invoice">
                                                        <button type="button"
                                                            ...
                                                            target="_blank"
                                                            data-action="{{ route('admin.purchase.print', $purchase->id) }}">
                                                            <span class="me-2">
                                                    ...
                                                    <x-permission_check permission="download purchase invoice">
                                                        <a class="dropdown-list d-block w-100 text-start"
                                                            href="{{ route('admin.purchase.pdf', $purchase->id) }}">
                                                            <span class="me-2">
...
@push('breadcrumb-plugins')
    <x-permission_check permission="add purchase">
        <x-admin.ui.btn.add href="{{ route('admin.purchase.add') }}" text="Add Purchase" />
    </x-permission_check>
@endpush
    ...
    <script>
        ...
        (function($) {
            ...
            $('.add-payment').on('click', function() {
                ...
                const action = ("{{ route('admin.purchase.ad.payment', ':id') }}").replace(":id", purchase.id);
            ...
            $(".update-status").on('click', function() {
                ...
                const action = "{{ route('admin.purchase.update.status', ':id') }}";
