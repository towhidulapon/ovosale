                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <x-admin.other.status_switch :status="$expenseCategory->status"
                                                action="{{ route('admin.expense.category.status.change', $expenseCategory->id) }}"
    ...
    <script>
        ...
        (function($) {
            ...
            $('.add-btn').on('click', function() {
                const action = "{{ route('admin.expense.category.create') }}";
            ...
            $('.edit-btn').on('click', function() {
                const action = "{{ route('admin.expense.category.update', ':id') }}";
