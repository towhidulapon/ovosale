...
@section('panel')
                            ...
                            <x-admin.ui.table.body>
                                @forelse($paymentAccounts as $paymentAccount)
                                    <tr>
                                        ...
                                        <td>
                                            <x-admin.other.status_switch :status="$paymentAccount->status" 
                                                :action="route('admin.payment.account.status.change',$paymentAccount->id,)"
                                        ...
                                        <td class="dropdown">
                                            @if (request()->trash)
                                                <button type="button" class="btn btn-outline--success confirmationBtn"
                                                    ...
                                                    data-action="{{ route('admin.payment.account.restore', $paymentAccount->id) }}">
                                                ...
                                                <div class="dropdown-menu dropdown">
                                                    ...
                                                    <x-permission_check permission="trash payment account">
                                                        <button
                                                            ...
                                                            data-action="{{ route('admin.payment.account.trash.temporary', $paymentAccount->id) }}">
    ...
    <x-admin.ui.modal id="balance-modal">
        <x-admin.ui.modal.header>
    ...
    <x-admin.ui.modal id="transfer-modal">
        <x-admin.ui.modal.header>
    ...
    <script>
        ...
        (function($) {
            ...
            $('.add-btn').on('click', function() {
                const action = "{{ route('admin.payment.account.create') }}";
            ...
            $('.add-balance').on('click', function() {
                const action = "{{ route('admin.payment.account.adjust.balance', ':id') }}";
            ...
            $('.transfer-balance').on('click', function() {
                const action = "{{ route('admin.payment.account.transfer.balance', ':id') }}";
                const id = $(this).data('id');
            ...
            $('.edit-btn').on('click', function() {
                const action = "{{ route('admin.payment.account.update', ':id') }}";
