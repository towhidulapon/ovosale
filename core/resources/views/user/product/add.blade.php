        ...
        <div class="col-12">
            <x-admin.ui.card>
                <x-admin.ui.card.body>
                    <form action="{{ route('admin.product.create') }}" method="POST" class="product-create-form"
        ...
        (function($) {
            ...
            const ajaxActionManager = {
                ...
                generateProductCodeAction: function() {
                    $.ajax({
                        type: "get",
                        url: "{{ route('admin.product.code.generate') }}",
                        dataType: "json",
...
@push('breadcrumb-plugins')
 <x-permission_check permission="view product">
    <a class="btn  btn-outline--primary" href="{{ route('admin.product.list') }}">
