...
@section('panel')
    <div class="row gy-4">
        <div class="col-12">
            @include('admin.purchase.invoice')
        </div>
        <div class="col-12">
            <div class="d-flex gap-3 flex-wrap">
                <x-permission_check permission="edit purchase">
                    <a class="btn btn--primary" href="{{ route('admin.purchase.edit', $purchase->id) }}">
                        <i class="las la-pencil-alt"></i>
                        @lang('Edit Purchase')
                    </a>
                </x-permission_check>
                <x-permission_check permission="download purchase invoice">
                    <a class="btn btn--info" href="{{ route('admin.purchase.pdf', $purchase->id) }}">
                ...
                <x-permission_check permission="view purchase">
                    <x-back_btn route="{{ route('admin.purchase.list') }}" />
                </x-permission_check>
            </div>
        </div>
    </div>
