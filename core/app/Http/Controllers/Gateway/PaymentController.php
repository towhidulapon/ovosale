...
use App\Http\Controllers\User\PlanSubscribeController;
...
class PaymentController extends Controller {
    ...
    public function insertDepositData($gate, $amount, $planPurchaseId = null) {
    ...
    public static function userDataUpdate($deposit, $isManual = null) {
        if ($deposit->status == Status::PAYMENT_INITIATE || $deposit->status == Status::PAYMENT_PENDING) {
            ...
            if (!$deposit->subscription_plan_id) {
            ...
            if($deposit->subscription_plan_id){
                (new PlanSubscribeController())->confirmPurchase($user, $deposit->subscription_plan_id, $deposit->amount);
            }
        }
    }
