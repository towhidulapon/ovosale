...
trait RoleOperation
{
    ...
    public function save(Request $request, $id = 0)
    {
        ...
        adminActivity($remark, get_class($role), $role->id);
    ...
    public function status($id)
    {
        ...
        adminActivity("role-status-change", get_class($role), $role->id);
    ...
    public function permissionUpdate(Request $request, $id)
    {
        ...
        //super admin permission never changed
        if ($role->id == Status::SUPER_ADMIN_ROLE_ID) {
        ...
        adminActivity("permission-updated", get_class($role), $role->id);
