...
trait WareHouseOperation
{
    ...
    public function list()
    {
        ...
        $baseQuery = Warehouse::whereIn('user_id', $userIds)->searchable(['name', 'contact_number'])->orderBy('id', getOrderBy())->trashFilter();
    ...
    public function save(Request $request, $id = 0)
    {
        ...
        if ($id) {
            ...
            $purchasedPlan = PlanPurchase::where('user_id', $user->id)->where('status', Status::PLAN_ACTIVATE)->first();
